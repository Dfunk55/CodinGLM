...
<Warning>
  Using the GLM Coding Plan, you need config the exclusive Coding API [https://api.z.ai/api/coding/paas/v4](https://api.z.ai/api/coding/paas/v4) instead of the Common API [https://api.z.ai/api/paas/v4](https://api.z.ai/api/paas/v4)
</Warning>
