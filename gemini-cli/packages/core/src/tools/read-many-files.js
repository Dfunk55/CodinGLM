        ...
        for (const result of results) {
            if (result.status === 'fulfilled') {
                ...
                if (!fileResult.success) {
                    ...
                    logFileOperation(this.config, new FileOperationEvent(READ_MANY_FILES_TOOL_NAME, FileOperation.READ, lines, mimetype, path.extname(filePath), programming_language));
                }
            }
            else {
