...
class EditToolInvocation extends BaseToolInvocation {
    ...
    async calculateEdit(params, abortSignal) {
        ...
        if (params.old_string === '' && !fileExists) {
            ...
            const correctedEdit = await ensureCorrectEdit(params.file_path, currentContent, params, this.config.getGeminiClient(), this.config.getBaseLlmClient(), abortSignal);
