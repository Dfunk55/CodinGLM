            ...
            const result = new Promise((resolve) => {
                ...
                const handleOutput = (data, stream) => {
                    ...
                    if (isStreamingRawContent) {
                        ...
                        if (stream === 'stdout') {
                            const { newBuffer, truncated } = this.appendAndTruncate(stdout, decodedChunk, MAX_CHILD_PROCESS_BUFFER_SIZE);
                            stdout = newBuffer;
                            if (truncated) {
                            ...
                            const { newBuffer, truncated } = this.appendAndTruncate(stderr, decodedChunk, MAX_CHILD_PROCESS_BUFFER_SIZE);
                            stderr = newBuffer;
                            if (truncated) {
