...
import type { Content, PartListUnion } from '../llm/types.js';
...
export interface RoutingStrategy {
   ...
   * @param client A reference to the LlmClient, allowing the strategy to make its own API calls if needed.
