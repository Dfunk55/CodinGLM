...
export interface ExcludeOptions {
  ...
  /**
   * Whether to include dynamic patterns like the current context markdown filename. Defaults to true.
   */
...
export class FileExclusions {
  ...
  getDefaultExcludePatterns(options: ExcludeOptions = {}): string[] {
    ...
    // Add dynamic patterns (like the current context markdown filename)
