...
vi.mock('../tools/memoryTool.js', () => ({
  getCurrentContextFilename: vi.fn(() => 'CODINGLM.md'),
}));
...
describe('FileExclusions', () => {
  ...
  describe('getDefaultExcludePatterns', () => {
    it('should return comprehensive patterns by default', () => {
      ...
      expect(patterns).toContain('**/CODINGLM.md');
    });
    ...
    it('should respect includeDefaults option', () => {
      ...
      expect(patterns).not.toContain('**/CODINGLM.md');
    ...
    it('should respect includeDynamicPatterns option', () => {
      ...
      expect(patternsWithDynamic).toContain('**/CODINGLM.md');
      expect(patternsWithoutDynamic).not.toContain('**/CODINGLM.md');
    });
  });
