...
import { debugLogger, isGitRepository } from '@codinglm/core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @codinglm/cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @codinglm/cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @codinglm/cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @codinglm/cli@latest';
    return {
