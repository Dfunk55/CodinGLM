...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific CodinGLM model for conversations (/settings)...',
  ...
  'Show CodinGLM status in the terminal window title (/settings)...',
  ...
  'Submit your prompt to CodinGLM with Enter...',
  ...
  'Create a project-specific CODINGLM.md file with /init...',
  ...
  'Reload instructional context from CODINGLM.md files with /memory refresh...',
  'List the paths of the CODINGLM.md files in use with /memory list...',
