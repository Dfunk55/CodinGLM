...
CodinGLM CLI extensions can be distributed through
...
To ensure CodinGLM CLI can automatically find the correct release asset for each
...
CodinGLM CLI extension for multiple platforms:
