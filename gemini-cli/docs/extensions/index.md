...
CodinGLM CLI extensions package prompts, MCP servers, and custom commands into a
familiar and user-friendly format. With extensions, you can expand the
capabilities of CodinGLM CLI and share those capabilities with others. They are
designed to be easily installable and shareable.

To see examples of extensions, you can browse a gallery of
[CodinGLM CLI extensions](https://geminicli.com/extensions/browse/).
...
[here](https://github.com/Dfunk55/CodinGLM/tree/main/packages/cli/src/commands/extensions/examples).
...
On startup, CodinGLM CLI looks for extensions in `<home>/.gemini/extensions`
...
- `contextFileName`: The name of the file that contains the context for the
  ...
  If this property is not used but a `CODINGLM.md` file is present in your
...
When CodinGLM CLI starts, it loads all the extensions and merges their
...
CodinGLM CLI extensions allow variable substitution in `gemini-extension.json`.
