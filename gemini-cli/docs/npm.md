...
This monorepo contains two main packages: `@codinglm/cli` and
`@codinglm/core`.

## `@codinglm/cli`

This is the main package for the CodinGLM CLI. It is responsible for the user
...
`@codinglm/core`. This means that whether a user installs the package
with `npm install -g @codinglm/cli` or runs it directly with
`npx @codinglm/cli`, they are using this single, self-contained executable.

## `@codinglm/core`

This package contains the core logic for interacting with the CodinGLM API. It is
