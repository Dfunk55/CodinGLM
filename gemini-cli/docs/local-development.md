...
2.  **Run CodinGLM CLI with Dev Tracing:**

    In a separate terminal, run your CodinGLM CLI command with the
...
```typescript
import { runInDevTraceSpan } from '@codinglm/core';
