...
This document describes the `save_memory` tool for the CodinGLM CLI.

## Description

Use `save_memory` to save and recall information across your CodinGLM CLI
...
## How to use `save_memory` with the CodinGLM CLI

The tool appends the provided `fact` to a special `CODINGLM.md` file located in
the user's home directory (`~/.gemini/CODINGLM.md`). This file can be configured
to have a different name.

Once added, the facts are stored under a `## CodinGLM Added Memories` section.
