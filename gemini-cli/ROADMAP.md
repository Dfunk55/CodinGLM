# CodinGLM CLI Roadmap

The
[Official CodinGLM CLI Roadmap](https://github.com/Dfunk55/CodinGLM/projects)

CodinGLM CLI is an open-source AI agent that brings the power of CodinGLM directly
into your terminal. It provides lightweight access to CodinGLM, giving you the
most direct path from your prompt to our model.

This document outlines our approach to the CodinGLM CLI roadmap. Here, you'll find
...
As an
[Apache 2.0 open source project](https://github.com/Dfunk55/CodinGLM?tab=Apache-2.0-1-ov-file#readme),
we appreciate and welcome
[public contributions](https://github.com/Dfunk55/CodinGLM/blob/main/CONTRIBUTING.md),
...
[opening an issue for discussion](https://github.com/Dfunk55/CodinGLM/issues/new/choose).
...
- **Power & Simplicity:** Deliver access to state-of-the-art GLM models with
...
- **Intelligent:** CodinGLM CLI should be reliably ranked among the best agentic
...
Roadmap Issue [here](https://github.com/Dfunk55/CodinGLM/issues/4191).
...
all our items [here](https://github.com/Dfunk55/CodinGLM/projects)
...
- **Authentication:** Secure user access via API keys, CodinGLM Code Assist login,
  etc.
- **Model:** Support new GLM models, multi-modality, local execution, and
  performance tuning.
...
- **Extensibility:** Bringing CodinGLM CLI to other surfaces e.g. GitHub.
...
CodinGLM CLI is an open-source project, and we welcome contributions from the
community! Whether you're a developer, a designer, or just an enthusiastic user
you can find our
[Community Guidelines here](https://github.com/Dfunk55/CodinGLM/blob/main/CONTRIBUTING.md)
to learn how to get started. There are many ways to get involved:

- **Roadmap:** Please review and find areas in our
  [roadmap](https://github.com/Dfunk55/CodinGLM/issues/4191) that you
...
- **Report Bugs:** If you find an issue, please create a
  [bug](https://github.com/Dfunk55/CodinGLM/issues/new?template=bug_report.yml)
...
- **Suggest Features:** Have a great idea? We'd love to hear it! Open a
  [feature request](https://github.com/Dfunk55/CodinGLM/issues/new?template=feature_request.yml).
- **Contribute Code:** Check out our
  [CONTRIBUTING.md](https://github.com/Dfunk55/CodinGLM/blob/main/CONTRIBUTING.md)
...
- **Write Documentation:** Help us improve our documentation, tutorials, and
  examples. We are excited about the future of CodinGLM CLI and look forward to
